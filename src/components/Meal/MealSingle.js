...
function MealSingle({ meal }) {
  ...
  return (
    <>
      ...
      <div className='my-4 card shadow-sm border-0 p-5 rounded-4'>
        <div className='row row-cols-1 row-cols-md-1 row-cols-lg-2 justify-content-center align-items-start'>
          <div className='col'>
            <img src={meal?.thumbnail} className='img-fluid' alt='mealImage' />
          </div>
          <div className='col'>
        ...
        <div className='bg-light p-3 my-3 rounded-4'>
          <h3>Measure:</h3>
          <ul className='row row-cols-1 row-cols-md-1 row-cols-lg-2 align-items-start'>
            {
